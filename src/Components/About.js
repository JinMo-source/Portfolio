      ...
      <LeftTextBox top="20vh" left="13vw">
        <AboutMe>
          ...
          <p>
            ...
            프로그램을 만드는지 관심을 가지게 되었습니다.
            <br />
            개발 하는데 있어 많은 언어가 사용되며 프론트 엔드와 백 엔드로 직업이
            나눠지는걸 알게 되었고 한번 배워보고 싶다는 생각을 가지게 되었으며
            국비 지원을 받아 학원을 다니게 되었습니다.
            <br />
            하지만 학원에서 배우는(html,css,javascript) 정도로는 회사에서 원하는
            프론트 엔드에 대한 수준을 맞추기 어렵다는걸 알았습니다.
            <br />
            그래서 처음은 웹 퍼블리셔로 취직을 하여 프론트 엔드,백 엔드는 어떤
            언어를 많이 쓰며 어떻게 일을 하는지를 배우며 나중에 제가 공부를 해야
            할 방향을 정하게 되었으며, 근무가 끝나 퇴근을 하면 프론트 엔드에
            대하여 공부를 하게 되었습니다.
            <br />
            <span>
